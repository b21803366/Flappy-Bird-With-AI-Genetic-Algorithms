...
//C:\OutputPID.csv
    ...
    private void Start() {
        ...
        Bird_Player.GetInstance().OnStartedPlaying += Bird_OnStartedPlaying;
        Bird_Player2.GetInstance().OnDied += Bird_OnDied;
        Bird_Player2.GetInstance().OnStartedPlaying += Bird_OnStartedPlaying;
    ...
    private void Bird_OnDied(object sender, System.EventArgs e) {
        ...
        if(sender.ToString() == "Rocket_Player (Bird_Player)")
            won_text = "2";
        else if(sender.ToString() == "Rocket_Player2 (Bird_Player2)")
            won_text = "1";
        text.text = "Player " + won_text + " Won";
    ...
    private void SetDifficulty(Difficulty difficulty) {
        ...
        case Difficulty.Easy:
            ...
            //UnityEngine.Debug.Log("Random : "+pipeSpawnTimerMax);
            break;
        case Difficulty.MediumB3:
            gapSize = 33f;
            pipeSpawnTimerMax = 0.694f;//(float)(rand.NextDouble()*(0.68 - 0.65) + 0.65);
            break;
         ...
         case Difficulty.MediumB2:
            gapSize = 33f;
            pipeSpawnTimerMax = 0.705f;//(float)(rand.NextDouble()*(0.63 - 0.55) + 0.55);
            break;
        case Difficulty.Rare1:
            gapSize = 34f;
            pipeSpawnTimerMax = (float)(rand.NextDouble()*(0.72 - 0.70) + 0.70);
            break;
        case Difficulty.Rare2:
            gapSize = 33f;
            pipeSpawnTimerMax = (float)(rand.NextDouble()*(0.71 - 0.69) + 0.69);
            break;
